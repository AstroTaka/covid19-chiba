  ...
  <div class="About">
    ...
    <StaticCard>
      <p>
        ...
        千葉県が公表しているデータをそのまま使用していますが、松戸市に関するデータは千葉県のデータから居住地が松戸市の物を抽出して作成しています。
      </p>
    </StaticCard>
    <StaticCard>
      <p>
    ...
    <StaticCard>
      <h3>免責事項</h3>
      <p>
        当サイトに掲載されている情報の正確性については万全を期していますが、千葉県や松戸市は利用者が当サイトの情報を用いて行う一切の行為について責任を負うものではありません。
      </p>
      <p>
        また、利用者が当サイトを利用したことにより発生した利用者の損害及び利用者が第三者に与えた損害に対して、責任を負うものではありません。
      </p>
      <p>
        当サイトや当サイトに掲載されている情報は予告なしに変更又は削除することがあります。
      </p>
    </StaticCard>
